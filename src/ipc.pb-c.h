...
typedef struct AuthCookieRequestMsg AuthCookieRequestMsg;
typedef struct FwPortSt FwPortSt;
typedef struct GroupCfgSt GroupCfgSt;
typedef struct AuthCookieReplyMsg AuthCookieReplyMsg;
typedef struct SessionResumeFetchMsg SessionResumeFetchMsg;
typedef struct SessionResumeStoreReqMsg SessionResumeStoreReqMsg;
typedef struct SessionResumeReplyMsg SessionResumeReplyMsg;
typedef struct TunMtuMsg TunMtuMsg;
typedef struct CliStatsMsg CliStatsMsg;
typedef struct UdpFdMsg UdpFdMsg;
typedef struct SnapshotEntryMsg SnapshotEntryMsg;
typedef struct WorkerStartupMsg WorkerStartupMsg;
typedef struct SessionInfoMsg SessionInfoMsg;
typedef struct BanIpMsg BanIpMsg;
typedef struct BanIpReplyMsg BanIpReplyMsg;
typedef struct LatencyStatsDelta LatencyStatsDelta;
typedef struct SecAuthInitMsg SecAuthInitMsg;
typedef struct SecAuthContMsg SecAuthContMsg;
typedef struct SecAuthReplyMsg SecAuthReplyMsg;
typedef struct SecOpMsg SecOpMsg;
typedef struct SecGetPkMsg SecGetPkMsg;
typedef struct SecmSessionOpenMsg SecmSessionOpenMsg;
typedef struct SecmSessionCloseMsg SecmSessionCloseMsg;
typedef struct SecmStatsMsg SecmStatsMsg;
typedef struct SecmSessionReplyMsg SecmSessionReplyMsg;
typedef struct CookieIntMsg CookieIntMsg;
typedef struct SecmListCookiesReplyMsg SecmListCookiesReplyMsg;
typedef struct SecmTerminateUserSessionsMsg SecmTerminateUserSessionsMsg;
typedef struct SecmTerminateSessionMsg SecmTerminateSessionMsg;
typedef struct SecmTerminateSessionReplyMsg SecmTerminateSessionReplyMsg;
typedef struct SnapshotStateMsg SnapshotStateMsg;
...
#define AUTH_COOKIE_REPLY_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&auth_cookie_reply_msg__descriptor) \
    , AUTH__REP__OK, 0, {0,NULL}, NULL, NULL, NULL, NULL, NULL, NULL, NULL, {0,NULL}, 0, {0,NULL}, NULL }


/*
 * RESUME_FETCH_REQ + RESUME_DELETE_REQ 
 */
struct  SessionResumeFetchMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData session_id;
  /*
 ...
 * RESUME_STORE_REQ 
 */
struct  SessionResumeStoreReqMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData session_id;
...
struct  SecAuthInitMsg
{
  ...
  /*
   * if proxy proto is in use this is
...
#define SEC_AUTH_INIT_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&sec_auth_init_msg__descriptor) \
    , 0, NULL, NULL, NULL, 0,NULL, NULL, 0u, NULL, NULL, NULL, NULL, NULL, 0, {0,NULL}, NULL }


/*
 * SEC_AUTH_CONT 
 */
struct  SecAuthContMsg
{
  ProtobufCMessage base;
  char *password;
  ProtobufCBinaryData sid;
...
#define SECM_SESSION_REPLY_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&secm_session_reply_msg__descriptor) \
    , AUTH__REP__OK, NULL, NULL, NULL, NULL, 0, {0,NULL}, 0, NULL, NULL, NULL, NULL, 0 }
 ...
 */
struct  SecmListCookiesReplyMsg
{
  ProtobufCMessage base;
  size_t n_cookies;
...
/*
 * SECM_TERMINATE_USER_SESSIONS: sent from main to sec-mod to invalidate all
 * session cookies for a given username. 
 */
struct  SecmTerminateUserSessionsMsg
{
  ProtobufCMessage base;
  char *username;
};
#define SECM_TERMINATE_USER_SESSIONS_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&secm_terminate_user_sessions_msg__descriptor) \
    , NULL }


/*
 * SECM_TERMINATE_SESSION: sent from main to sec-mod to invalidate a single
 * session cookie by its safe_id. 
 */
struct  SecmTerminateSessionMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData safe_id;
};
#define SECM_TERMINATE_SESSION_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&secm_terminate_session_msg__descriptor) \
    , {0,NULL} }


/*
 * Reply for both terminate commands 
 */
struct  SecmTerminateSessionReplyMsg
{
  ProtobufCMessage base;
  protobuf_c_boolean result;
};
#define SECM_TERMINATE_SESSION_REPLY_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&secm_terminate_session_reply_msg__descriptor) \
    , 0 }
...
void   secm_list_cookies_reply_msg__free_unpacked
                     (SecmListCookiesReplyMsg *message,
                      ProtobufCAllocator *allocator);
/* SecmTerminateUserSessionsMsg methods */
...
void   secm_terminate_user_sessions_msg__free_unpacked
                     (SecmTerminateUserSessionsMsg *message,
                      ProtobufCAllocator *allocator);
/* SecmTerminateSessionMsg methods */
...
void   secm_terminate_session_msg__free_unpacked
                     (SecmTerminateSessionMsg *message,
                      ProtobufCAllocator *allocator);
/* SecmTerminateSessionReplyMsg methods */
...
typedef void (*SecmListCookiesReplyMsg_Closure)
                 (const SecmListCookiesReplyMsg *message,
                  void *closure_data);
typedef void (*SecmTerminateUserSessionsMsg_Closure)
                 (const SecmTerminateUserSessionsMsg *message,
                  void *closure_data);
typedef void (*SecmTerminateSessionMsg_Closure)
                 (const SecmTerminateSessionMsg *message,
                  void *closure_data);
typedef void (*SecmTerminateSessionReplyMsg_Closure)
                 (const SecmTerminateSessionReplyMsg *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor secm_terminate_user_sessions_msg__descriptor;
extern const ProtobufCMessageDescriptor secm_terminate_session_msg__descriptor;
extern const ProtobufCMessageDescriptor secm_terminate_session_reply_msg__descriptor;
