...
void   safe_id_req__init
                     (SafeIdReq         *message)
{
  static const SafeIdReq init_value = SAFE_ID_REQ__INIT;
  *message = init_value;
}
size_t safe_id_req__get_packed_size
                     (const SafeIdReq *message)
{
  assert(message->base.descriptor == &safe_id_req__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  return (SafeIdReq *)
     protobuf_c_message_unpack (&safe_id_req__descriptor,
                                allocator, len, data);
}
...
static const ProtobufCFieldDescriptor user_info_rep__field_descriptors[34] =
{
  {
    "id",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT64,
    0,   /* quantifier_offset */
    offsetof(UserInfoRep, session_start_time),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned user_info_rep__field_indices_by_name[] = {
  ...
  31,   /* field[31] = safe_id */
  33,   /* field[33] = session_start_time */
  12,   /* field[12] = status */
...
static const ProtobufCFieldDescriptor safe_id_req__field_descriptors[1] =
{
  {
    "safe_id",
    1,
...
static const unsigned safe_id_req__field_indices_by_name[] = {
  0,   /* field[0] = safe_id */
};
static const ProtobufCIntRange safe_id_req__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 1 }
};
const ProtobufCMessageDescriptor safe_id_req__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "safe_id_req",
  "SafeIdReq",
  ...
  sizeof(SafeIdReq),
  1,
  safe_id_req__field_descriptors,
  safe_id_req__field_indices_by_name,
  1,  safe_id_req__number_ranges,
  (ProtobufCMessageInit) safe_id_req__init,
  NULL,NULL,NULL    /* reserved[123] */
};
